...
interface MemberCardProps {
  member: TeamMember;
  onConfigClick?: (member: TeamMember) => void;
}
...
export const MemberCard: React.FC<MemberCardProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {onConfigClick && (
        <button
          onClick={() => onConfigClick(member)}
          className="w-full py-4 border border-white/10 bg-zinc-900/20 text-zinc-400 hover:text-black hover:bg-white hover:border-white transition-all duration-300 group/btn"
        >
